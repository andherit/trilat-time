...
!2025A passing verbose from logical to integer
!2025A    verbose = 0, no output
!2025A    verbose = 1, workflow output
!2025A    verbose = 2, workflow output and debug output
!2025A    verbose = 3, temporary debug output
integer(pin) :: verbose=0 ! 0,1,2,3
